    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-teal-50 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {result && (
            <div className={`mb-8 p-8 rounded-2xl border-2 shadow-xl transform transition-all ${
              errorState === 'handled'
              ...
              <div className="flex items-start">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center mr-4 ${
                  errorState === 'handled' ? 'bg-yellow-500' : 'bg-green-500'
                }`}>
                ...
                <div className="flex-1">
                  <h3 className={`text-2xl font-bold mb-2 ${
                    errorState === 'handled' ? 'text-yellow-900' : 'text-green-900'
                  }`}>
                    {errorState === 'handled' ? '⚠️ Error Handled' : '✅ Success'}
                  </h3>
                  <p className="text-lg font-mono bg-white bg-opacity-70 p-4 rounded-lg">{result}</p>
                  <div className={`mt-3 text-sm px-4 py-2 rounded-full inline-block ${
                    errorState === 'handled'
            ...
            <div className="overflow-x-auto bg-white rounded-xl shadow-lg">
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 font-bold text-gray-900 bg-gray-50">Qachon ishlatish</td>
                    <td className="px-6 py-4">
